...
#[test]
fn ex7_2() {
    const READ_FILE_PATH: &'static str = "assets/ex7/white_noise.wav";
    const WRITE_FILE_PATH: &'static str = "assets/ex7/ex7_2.wav";
    ...
    let new_container = EFilter::IIRLowPass {
        edge_frequency: EEdgeFrequency::ChangeBySample(|sample_i, sample_count| {
            ...
            BASE_EDGE_FREQUENCY * (-7.5 * sample_rate).exp()
        }),
